module.exports.function = function searchFestivalsByThisMonth (searchMonth) {
  ...
  //url=baseURL+"&sortStdr=1&from=20180305&to=20180331&cPage=1&rows=10&place=1"
  ...
  thisday=yyyy+mm+"01";
  url=baseURL+"&sortStdr=1&from="+yyyy+mm+"01"+"&to="+yyyy+mm+"31"+"&cPage=1&rows=10&place=1"
  response = http.getUrl(url, {format:"xmljs"});
  
  console.log("TODAY IS:",yyyy+mm+dd);
  console.log("PLAY IS:",yyyy+mm+"01"+"~"+yyyy+mm+"31");
